...
Ideas without a briefing yet. Features 1–3 are implemented, 4 and 5 are in
progress, 6 and 7 are planned, and A–C are briefed. These are the gaps that remain
beyond all of them.
