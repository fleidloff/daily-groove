...
| [12](feature-12/) | Shareable grooves | 🛠 Ready to implement | Gives every groove a uuid and a share button, so a groove can be sent to someone and opened on any day — and an archive becomes possible later. |
...
|:-----------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|
| **Instruments**                    | Think about the used instruments again. Maybe a drum kit is better than a cajon                                                                                                                                            | Makes the grooves sound better                                                                                                                       |
...
| **Explain the answer**             | After solving, show *why* it's Dorian: the scale degrees, the characteristic note, and an A/B listen against a neighbouring mode. Use the bottom box and remove everything (streak, tries) related to the puzzle from it.  | Turns a guessing game into ear training. This is the difference between a player who churns in a week and one who returns to learn.                  |
