...
| [C](feature-c/) | Natural feel | ✏️ Briefed | Adds micro-timing, velocity and swing to groove generation, and regenerates the existing grooves with it. |
| [D](feature-d/) | Playback bug fixes | ✏️ Briefed | Stops an archived groove driving the loop visualisation in today's groove card, plus other small fixes. |

---

## Candidate features (auto-generated by Claude)

Ideas without a briefing yet. Features 1–3 are implemented, 4 is planned, 5 is
in progress, and A–D are briefed. These are the gaps that remain beyond all of
them.

| Idea                               | Summary                                                                                                                                                | Why it's worth it                                                                                                                                    |
|:-----------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|
| **Jazz Font**                      | Use the same font as the Real Books for titles                                                                                                         | Will feel more jazzy (at least to people who know the real books)                                                                                    |
