...
| [5](feature-5/) | Structure and guidelines | 🛠 Ready to implement | Reorganises the design system and the feature slice into named sub-folders, dismantles the god component and the cross-boundary test imports, and writes the resulting rules into `docs/coding-guidelines.md` where lint enforces them. |
...
Ideas without a briefing yet. Features 1–3 are implemented, 4–5 are planned, and
A–C are briefed. These are the gaps that remain beyond all of them.
