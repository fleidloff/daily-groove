...
| [10](feature-10/) | Hear the root | 🔨 In progress | Gives the root row a voice — tap a root to hear it against the running groove, so the home note can be found by ear instead of guessed. |
